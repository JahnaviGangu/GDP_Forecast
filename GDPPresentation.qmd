...
![](images/gdp_image.jpeg){fig-align="center"}
...
-   The forecast plot from the ETS model shows the fitted time series data with a forecast extending into the future, including a shaded area representing the confidence interval around the predictions.
